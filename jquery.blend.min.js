...
(function(l){l.fn.blend=function(j){function c(b,a){this.algorithm=b;this.precision=a;this.process=function(g,i){if(this.precision!="subpixel")return[this.algorithm(g[0],i[0]),this.algorithm(g[1],i[1]),this.algorithm(g[2],i[2])]}}j=l.extend({mode:"normal",adjustment:"rgb(128, 128, 128)",opacity:1},j);var q={normal:new c(function(b,a){return a}),none:new c(function(b,a){return b}),darken:new c(function(b,a){return Math.min(b,a)}),multiply:new c(function(b,a){return b*a/255}),colorburn:new c(function(b,a){return a<=0?0:Math.max(255-(255-
